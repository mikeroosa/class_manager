defmodule ClassManagerWeb.EventLive.Index do
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:event, EventCtx.get_event!(id))
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    event = EventCtx.get_event!(id)
    {:ok, _} = EventCtx.delete_event(event)

    {:noreply, assign(socket, :events, list_events())}
  end

  defp list_events do
    EventCtx.list_events()
  end
end
