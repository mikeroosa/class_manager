defmodule ClassManagerWeb.ContactLive.Index do
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:contact, ContactCtx.get_contact!(id))
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    contact = ContactCtx.get_contact!(id)
    {:ok, _} = ContactCtx.delete_contact(contact)

    {:noreply, assign(socket, :contacts, list_contacts())}
  end

  defp list_contacts do
    ContactCtx.list_contacts()
  end
end
