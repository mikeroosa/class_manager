defmodule ClassManagerWeb.EventLiveTest do
  ...
  @create_attrs %{scheduled_for: ~N[2010-04-17 14:00:00], title: "some title"}
  ...
  defp fixture(:event) do
    {:ok, event} = EventCtx.create_event(@create_attrs)
    event
  end
